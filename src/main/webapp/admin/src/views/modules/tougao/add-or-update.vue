<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="投稿时间" prop="tougaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tougaoshijian" 
                type="datetime"
                placeholder="投稿时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tougaoshijian" label="投稿时间" prop="tougaoshijian">
              <el-input v-model="ruleForm.tougaoshijian" 
                placeholder="投稿时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.tougaoshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shipinmingcheng = true;
          ...
          if(o=='tougaoshijian'){
            this.ruleForm.tougaoshijian = obj[o];
	    this.ro.tougaoshijian = true;
            continue;
          }
          if(o=='fenlei'){
      ...
      this.$http({
		...
		if(json.mima!=''&&json.mima){
              		this.ruleForm.mima = json.mima
		}
        } else {
	...
	this.ruleForm.jianjie = this.ruleForm.jianjie.replace(reg,'../../../ssm617bx/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tougao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tougaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
