<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发货地" prop="fahuodi">
          <el-input v-model="ruleForm.fahuodi" 
              placeholder="发货地" clearable  :readonly="ro.fahuodi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发货地" prop="fahuodi">
              <el-input v-model="ruleForm.fahuodi" 
                placeholder="发货地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销量" prop="xiaoliang">
          <el-input v-model="ruleForm.xiaoliang" 
              placeholder="销量" clearable  :readonly="ro.xiaoliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销量" prop="xiaoliang">
              <el-input v-model="ruleForm.xiaoliang" 
                placeholder="销量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="参数" prop="canshu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.canshu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.canshu" label="参数" prop="canshu">
                    <span v-html="ruleForm.canshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinfenlei = true;
          ...
          if(o=='fahuodi'){
            this.ruleForm.fahuodi = obj[o];
	    this.ro.fahuodi = true;
            continue;
          }
          if(o=='xiaoliang'){
            this.ruleForm.xiaoliang = obj[o];
	    this.ro.xiaoliang = true;
            continue;
          }
          if(o=='canshu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/shangpinleixing/shangpinfenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.canshu = this.ruleForm.canshu.replace(reg,'../../../ssm617bx/upload');
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm617bx/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shangcheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangchengCrossAddOrUpdateFlag = false;
                  this.parent.search();
